...
発電実績と燃料実績は列の構成や見出しが年度で変わる（発電実績は蓄電池・配電事業者・特定卸供給事業者の
列が後から足された。燃料実績は2016年度にだけ余分な列があり、2021年4月は月末貯蔵量の見出しが
年度末貯蔵量になっている）ため、列位置ではなく見出しで対応づけている。知らない見出しが出たら
そこで失敗する。事業者別の電力需要実績は
