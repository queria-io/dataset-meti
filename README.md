...
- [経済産業省 資源エネルギー庁](https://www.enecho.meti.go.jp/statistics/electric_power/ep002/)の電力調査統計。
  ...
  需要電力量と逆潮流量を市区町村別・月次で、火力発電所が消費した燃料を燃料種別・月次で示します。
  都道府県別の需要量・発電量には事業者別の内訳もあります。
...
発電実績・市町村別逆潮流量・燃料実績は列の構成や見出しが年度で変わる（発電実績と逆潮流量は
蓄電池・配電事業者・特定卸供給事業者の列が後から足された。燃料実績は2016年度にだけ余分な列があり、
2021年4月は月末貯蔵量の見出しが年度末貯蔵量になっている）ため、列位置ではなく見出しで
対応づけている。知らない見出しが出たらそこで失敗する。事業者別の電力需要実績は
