...
def main() -> None:
    ...
    logger.info("6/11: power_generation_operator (電力調査統計 発電実績 事業者別)")
    ...
    logger.info("7/11: power_municipality (電力調査統計 市町村別需要電力量・逆潮流量)")
